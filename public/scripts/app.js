...
(function() {
  'use strict';
  angular.module('app', ['ui.router', 'ngCookies', 'ngAnimate', 'ui.bootstrap', 'easypiechart', 'mgo-angular-wizard', 'textAngular', 'ui.tree', 'ngMap', 'ngTagsInput', 'angular-intro', 'angularFileUpload', 'app.controllers', 'app.directives', 'app.localization', 'app.nav', 'app.task', 'app.user', 'app.product', 'app.venue', 'app.confirmation', 'app.ui.services']).config([
