...
module.exports = (grunt) ->
    ...
    grunt.initConfig
        ...
        clean:
            dist:
                files: [
                    dot: true
                    src: [".tmp", "<%= yeoman.dist %>/*", "!<%= yeoman.dist %>/.git*","!<%= yeoman.dist %>/api/*","!<%= yeoman.dist %>/images/*","!<%= yeoman.dist %>/api-docs.json"]
                ]
    ...
    #grunt.registerTask "build", ["useminPrepare", "concurrent:dist", "copy:dist", "concat", "uglify", "usemin"]
    #grunt.registerTask "lessBuild", [ "useminPrepare", "concurrent:lessDist", "copy:dist", "concat", "uglify", "usemin"]

    grunt.registerTask "default", ["concurrent:lessServer"]